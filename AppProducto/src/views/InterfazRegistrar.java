...
public class InterfazRegistrar extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InterfazRegistrar frame = new InterfazRegistrar();
	...
	public InterfazRegistrar() {
		...
		btnVolver.setIcon(imagenvolver);
		...
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGap(18)
					.addComponent(btnVolver, GroupLayout.PREFERRED_SIZE, 107, GroupLayout.PREFERRED_SIZE)
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
						...
						.addComponent(btnVolver, GroupLayout.PREFERRED_SIZE, 32, GroupLayout.PREFERRED_SIZE))
					.addGap(11))
		);
