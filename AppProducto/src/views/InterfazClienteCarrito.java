	...
	public InterfazClienteCarrito() {
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup().addContainerGap()
						.addComponent(scrollPane, GroupLayout.DEFAULT_SIZE, 386, Short.MAX_VALUE).addContainerGap())
				.addGroup(Alignment.TRAILING,
						groupLayout.createSequentialGroup().addGap(34)
								...
								.addGap(33)
								.addComponent(precioTotal, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.RELATED, 47, Short.MAX_VALUE)
								.addComponent(botonPagar).addGap(20)));
		...
		botonPagar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				while (it.hasNext()) {
					...
					Compra c = new Compra(String.valueOf(ultimocompra()), currentDate, time,
							InterfazLogin.User.getId_Usuario(), id_producto, InterfazClienteBuscar.carrito.get(key),
							precio_Total);
