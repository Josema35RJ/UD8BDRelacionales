...
public class InterfazAdmin extends JFrame {
	...
	private ImageIcon Clienteimagen, ProveedorImagen, ProductoImagen, PedidosImagen, ComprasImagen, SalirImagen,
			VolverImagen;
	...
	public InterfazAdmin() {
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
				.addGroup(groupLayout.createSequentialGroup().addGap(60)
						...
						.addComponent(Salir, GroupLayout.PREFERRED_SIZE, 132, GroupLayout.PREFERRED_SIZE).addGap(59))
				.addGroup(groupLayout.createSequentialGroup().addGap(18)
						.addComponent(Productos, GroupLayout.PREFERRED_SIZE, 164, GroupLayout.PREFERRED_SIZE).addGap(10)
						.addComponent(Compras, GroupLayout.PREFERRED_SIZE, 176, GroupLayout.PREFERRED_SIZE).addGap(18)
						.addComponent(Proveedores, GroupLayout.DEFAULT_SIZE, 177, Short.MAX_VALUE).addGap(21))
		...
		Salir.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				int op = JOptionPane.showConfirmDialog(InterfazAdmin.this, "Seguro Quiere Cerrar Ventana",
						"Cerrar Ventana Admin", JOptionPane.CANCEL_OPTION);
				if (op == 0) {
					System.exit(0);
				}
			}
