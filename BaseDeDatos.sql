...
--
-- Host: containers-us-west-94.railway.app    Database: sys
-- ------------------------------------------------------
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2023-05-12 10:33:10',NULL),('diagnostics.include_raw','OFF','2023-05-12 10:33:10',NULL),('ps_thread_trx_info.max_length','65535','2023-05-12 10:33:10',NULL),('statement_performance_analyzer.limit','100','2023-05-12 10:33:10',NULL),('statement_performance_analyzer.view',NULL,'2023-05-12 10:33:10',NULL),('statement_truncate_len','64','2023-05-12 10:33:10',NULL);
...
-- Dump completed on 2023-05-20  1:42:19
...
-- MySQL dump 10.13  Distrib 8.0.33, for Win64 (x86_64)
--
-- Host: containers-us-west-94.railway.app    Database: gestionra8
-- ------------------------------------------------------
-- Server version	8.0.33
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `Compra` (
  `Id_Compra` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `Fecha` date NOT NULL,
  `Hora` time NOT NULL,
  `Id_UsuarioC` varchar(45) NOT NULL,
  `Id_Producto` varchar(45) NOT NULL,
  `Cantidad_pedida` int NOT NULL,
  `Precio_Total` double DEFAULT NULL,
  PRIMARY KEY (`Id_Compra`),
  KEY `idUsuario_idx` (`Id_UsuarioC`),
  KEY `idCompra_idx` (`Id_Producto`),
  CONSTRAINT `Id_Producto` FOREIGN KEY (`Id_Producto`) REFERENCES `Producto` (`Id_Producto`),
  CONSTRAINT `Id_UsuarioC` FOREIGN KEY (`Id_UsuarioC`) REFERENCES `Usuario` (`Id_Usuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Compra` VALUES ('10','2023-05-18','00:02:14','2','2',10000,NULL),('11','2023-05-18','00:02:14','2','2',20000,59999800),('12','2023-05-18','11:45:29','2','2',30,89999.7),('14','2023-05-18','11:57:59','2','2',100,299999),('15','2023-01-20','12:00:00','4','2',100,299999),('16','1970-01-01','12:00:00','4','2',15,44999.85),('17','2023-05-19','12:10:38','2','2',20,59999.8),('18','2023-05-19','12:12:07','2','2',3,8999.97),('2','2023-01-20','12:00:00','2','2',400,1199996),('20','2023-05-19','13:23:50','4','4',2,1500),('21','2023-05-19','13:25:34','4','5',12,1500),('22','2023-05-19','13:42:16','4','5',3,9),('23','2023-05-19','13:46:20','4','5',4,12),('24','2023-05-19','13:46:39','4','5',6,18),('26','2023-05-19','13:53:34','4','5',50,150),('27','2023-05-19','13:56:21','4','5',50,150),('28','2023-05-19','13:56:48','4','5',50,150),('29','2023-05-19','13:56:48','4','4',2,40),('3','1970-01-01','00:03:23','2','2',998,2984990.05),('30','2023-05-19','13:56:48','4','2',234,701997.6875),('31','2023-05-19','13:56:48','4','3',4,843.9600219726562),('32','2023-05-19','13:57:11','4','5',50,150),('33','2023-05-19','13:57:11','4','4',2,40),('34','2023-05-19','13:57:11','4','2',234,701997.6875),('35','2023-05-19','13:57:11','4','3',4,843.9600219726562),('36','2023-05-19','13:57:17','4','5',50,150),('37','2023-05-19','13:57:17','4','4',2,40),('38','2023-05-19','13:57:17','4','2',234,701997.6875),('39','2023-05-19','13:57:17','4','3',4,843.9600219726562),('4','2023-01-20','12:00:00','10','2',2,5999.98),('40','2023-05-19','13:57:22','4','5',50,150),('41','2023-05-19','13:57:22','4','4',2,40),('42','2023-05-19','13:57:22','4','2',234,701997.6875),('43','2023-05-19','13:57:22','4','3',4,843.9600219726562),('44','2023-05-19','13:57:29','4','5',50,150),('45','2023-05-19','13:57:29','4','4',2,40),('46','2023-05-19','13:57:29','4','2',234,701997.6875),('47','2023-05-19','13:57:29','4','3',4,843.9600219726562),('48','2023-05-19','13:57:33','4','5',50,150),('49','2023-05-19','13:57:33','4','4',2,40),('50','2023-05-19','13:57:33','4','2',234,701997.6875),('51','2023-05-19','13:57:33','4','3',4,843.9600219726562),('52','2023-05-19','13:57:37','4','5',50,150),('53','2023-05-19','13:57:37','4','4',2,40),('54','2023-05-19','13:57:37','4','2',234,701997.6875),('55','2023-05-19','13:57:37','4','3',4,843.9600219726562),('56','2023-05-19','14:00:40','4','5',3,9),('57','2023-05-19','14:00:40','4','2',2,5999.97998046875),('58','2023-05-19','14:00:40','4','3',60,12659.400390625),('59','2023-05-19','14:02:02','4','2',2,5999.97998046875),('60','2023-05-19','22:40:26','4','5',3,9);
...
INSERT INTO `Producto` VALUES ('2','Bicicleta','IconProducts\\Bicicleta2Electric.jpg','Material Fibra De Carbono Con Ruedas de Plomo',2999.99,34063,'1','Deporte'),('3','Raqueta','IconProducts\\BalonFutbolD1.jpg','Naylon Con Fibra Negro VNSDJFNIDNDSIFNSD',210.99,9912,'1','Deporte'),('4','Balon Fubtol','IconProducts\\BalonFutbolD1.jpg','Blanco Con Rayas Negras',20,1972,'1','Deporte'),('5','Rueda','IconProducts\\BalonFutbolD1.jpg','Rueda pinchada',3,859,'1','Deporte');
...
INSERT INTO `Proveedor` VALUES ('1','Maria','Urb El Laberinto','123'),('2','Marta','Calle Lopez 2','123'),('3','Raul','Calle Salesianos','123');
...
INSERT INTO `Usuario` VALUES ('1','Ivan Cruzado','Calle Falla 1',1,'123',1),('10','Pepillo','DAEFSHYG',0,'Pepillo7',1),('11','Jose','Plaza del puerco 2',0,'Jose123*',0),('2','Jose Manuel','Calle Farola 5',1,'123',1),('3','Adrian Centeno','Calle Calasia',1,'123',1),('4','Felix','Calle Farola 4',0,'123',1),('5','Manuel','Calle Colegio 2',0,'123',0);
/*!40000 ALTER TABLE `Usuario` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'gestionra8'
--

--
-- Dumping routines for database 'gestionra8'
--
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2023-05-20  1:42:33
